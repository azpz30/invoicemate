            ...
            >
                {success ? (
                    <div style={{ textAlign: "center", display: "flex", flexDirection: "column", gap: "16px" }}>
                        ...
                        <div>
                            <h2 style={{ margin: "0 0 8px 0" }}>Check your email</h2>
                            <p style={{ margin: 0, fontSize: "0.875rem" }}>
                                We sent a confirmation link to <strong style={{ color: "var(--color-text)" }}>{email}</strong>. Click it to activate your account.
                            </p>
                        </div>
                        <Link href="/login" className="btn btn-secondary btn-md" style={{ alignSelf: "center" }}>
                            Back to sign in
                        </Link>
                    </div>
                ) : (
                    <>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "20px", alignItems: "center", textAlign: "center" }}>
                            ...
                            <div>
                                <h1 style={{ margin: "0 0 6px 0", fontSize: "1.375rem" }}>Create your account</h1>
                                <p style={{ margin: 0, fontSize: "0.875rem" }}>Free to use. No credit card required.</p>
                            </div>
                        </div>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                            ...
                            <button
                                ...
                                style={{ width: "100%", justifyContent: "center" }}
                            >
                                <svg width="16" height="16" viewBox="0 0 384 512" style={{ color: "var(--color-text)" }}>
                        ...
                        <form onSubmit={handleSignup} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                            ...
                            <div className="form-group">
                                <label htmlFor="signup-password" className="label">
                                    Password{" "}
                                    <span style={{ color: "var(--color-text-3)", fontWeight: 400 }}>(min 8 characters)</span>
                                </label>
                            ...
                            <p style={{ textAlign: "center", fontSize: "0.75rem", margin: 0, color: "var(--color-text-3)" }}>
